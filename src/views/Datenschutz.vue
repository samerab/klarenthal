...
<template>
  <div class="content mr-1 ml-1">
    <h1>Datenschutzerklärung</h1>
    <p>
      Wir freuen uns sehr über Ihr Interesse an unserem Verein. Datenschutz hat einen besonders
      hohen Stellenwert für die Geschäftsleitung des DJK 1. SC Klarenthal 1968 e. V. Eine Nutzung
      der Internetseiten des DJK 1. SC Klarenthal 1968 e. V. ist grundsätzlich ohne jede Angabe
      personenbezogener Daten möglich. Sofern eine betroffene Person besondere Services unseres
      Vereins über unsere Internetseite in Anspruch nehmen möchte, könnte jedoch eine Verarbeitung
    ...
    <p>
      ...
      Datenschutz-Grundverordnung und in Übereinstimmung mit den für den DJK 1. SC Klarenthal 1968
      e. V. geltenden landesspezifischen Datenschutzbestimmungen. Mittels dieser
      Datenschutzerklärung möchte unser Verein die Öffentlichkeit über Art, Umfang und Zweck der von
    ...
    <p>
      Der DJK 1. SC Klarenthal 1968 e. V. hat als für die Verarbeitung Verantwortlicher zahlreiche
    ...
    <p>
      Die Datenschutzerklärung des DJK 1. SC Klarenthal 1968 e. V. beruht auf den Begrifflichkeiten,
    ...
    <p>DJK 1. SC Klarenthal 1968 e. V.</p>
    <p>Geschwister-Scholl-Str. 8</p>
    <p>65197 Wiesbaden</p>
    <p>Deutschland</p>
    <p>Tel.: 0611 / 46 82 21</p>
    <p>E-Mail: <a href="mailto:sc-klarenthal@t-online.de">sc-klarenthal@t-online.de</a></p>
    <p>Website: <a href="http://www.sc-klarenthal.de">www.sc-klarenthal.de</a></p>
    ...
    <p>Deutschland</p>
    <p>Tel.: 06124 / 7 27 99 77</p>
    <p>E-Mail: <a href="mailto:steimel@rast-software.de">steimel@rast-software.de</a></p>
    <p>Website: <a href="http://www.rast-software.de">www.rast-software.de</a></p>
    <p>
    ...
    <h3>4. Cookies</h3>
    <p>
      Die Internetseiten des DJK 1. SC Klarenthal 1968 e. V. verwenden Cookies. Cookies sind
    ...
    <p>
      Durch den Einsatz von Cookies kann der DJK 1. SC Klarenthal 1968 e. V. den Nutzern dieser
    ...
    <p>
      ...
      Warenkorbs im Online-Shop. Der Online-Shop merkt sich die Artikel, die ein Kunde in den
    ...
    <p>
      Die Internetseite des DJK 1. SC Klarenthal 1968 e. V. erfasst mit jedem Aufruf der
    ...
    <p>
      Bei der Nutzung dieser allgemeinen Daten und Informationen zieht der DJK 1. SC Klarenthal 1968
      e. V. keine Rückschlüsse auf die betroffene Person. Diese Informationen werden vielmehr
      ...
      Internetseite zu gewährleisten sowie (4) Strafverfolgungsbehörden im Falle eines
      Cyberangriffes die zur Strafverfolgung notwendigen Informationen bereitzustellen. Diese anonym
      erhobenen Daten und Informationen werden durch den DJK 1. SC Klarenthal 1968 e. V. daher
      einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die
      Datensicherheit in unserem Verein zu erhöhen, um letztlich ein optimales Schutzniveau für die
      von uns verarbeiteten personenbezogenen Daten sicherzustellen. Die anonymen Daten der
    ...
    <p>
      ...
      erfolgt vor dem Hintergrund, dass nur so der Missbrauch unserer Dienste verhindert werden kann
      und diese Daten im Bedarfsfall ermöglichen, begangene Straftaten aufzuklären. Insofern ist die
    ...
    <p>
      ...
      gesetzlichen Aufbewahrungspflichten entgegenstehen. Ein in dieser Datenschutzerklärung
      namentlich benannter Datenschutzbeauftragter und die Gesamtheit der Mitarbeiter des für die
    ...
    <p>
      Auf der Internetseite des DJK 1. SC Klarenthal 1968 e. V. wird den Benutzern die Möglichkeit
      eingeräumt, den Newsletter unseres Vereins zu abonnieren. Welche personenbezogenen Daten bei
    ...
    <p>
      Der DJK 1. SC Klarenthal 1968 e. V. informiert seine Kunden und Geschäftspartner in
      regelmäßigen Abständen im Wege eines Newsletters über Angebote des Vereins. Der Newsletter
      unseres Vereins kann von der betroffenen Person grundsätzlich nur dann empfangen werden, wenn
      ...
      erstmalig für den Newsletterversand eingetragene E-Mail-Adresse wird aus rechtlichen Gründen
      eine Bestätigungsmail im Double-Opt-In-Verfahren versendet. Diese Bestätigungsmail dient der
    ...
    <p>
      ...
      vergebene IP-Adresse des vom betroffenen Person zum Zeitpunkt der Anmeldung verwendeten
      Computersystems sowie das Datum und die Uhrzeit der Anmeldung. Die Erhebung dieser Daten ist
      erforderlich, um den (möglichen) Missbrauch der E-Mail-Adresse einer betroffenen Person zu
      einem späteren Zeitpunkt nachvollziehen zu können und dient deshalb der rechtlichen
    ...
    <p>
      Die Newsletter des DJK 1. SC Klarenthal 1968 e. V. enthalten sogenannte Zählpixel. Ein
      Zählpixel ist eine Miniaturgrafik, die in solche E-Mails eingebettet wird, welche im
      HTML-Format versendet werden, um eine Logdatei-Aufzeichnung und eine Logdateianalyse zu
      ermöglichen. Dadurch kann eine statistische Auswertung des Erfolges oder Misserfolges von
      Online-Marketing-Kampagnen durchgeführt werden. Anhand des eingebetteten Zählpixels kann der
      DJK 1. SC Klarenthal 1968 e. V. erkennen, ob und wann eine E-Mail von einer betroffenen Person
    ...
    <p>
      ...
      werden vom für die Verarbeitung Verantwortlichen gespeichert und ausgewertet, um den
      ...
      gesonderte, über das Double-Opt-In-Verfahren erteilte Einwilligungserklärung zu widerrufen.
      Nach einem Widerruf werden diese personenbezogenen Daten vom für die Verarbeitung
      Verantwortlichen gelöscht. Eine Abmeldung vom Erhalt des Newsletters deutet der DJK 1. SC
      Klarenthal 1968 e. V. automatisch als Widerruf.
    </p>

    <h3>9. Kontaktmöglichkeit über die Internetseite</h3>
    <p>
      Die Internetseite des DJK 1. SC Klarenthal 1968 e. V. enthält aufgrund von gesetzlichen
      Vorschriften Angaben, die eine schnelle elektronische Kontaktaufnahme zu unserem Verein sowie
    ...
    <p>
      <b>a) Recht auf Bestätigung</b><br />Jede betroffene Person hat das vom Europäischen
    ...
    <p>
      <b>b) Recht auf Auskunft</b><br />Jede von der Verarbeitung personenbezogener Daten betroffene
      Person hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht, jederzeit
      von dem für die Verarbeitung Verantwortlichen unentgeltliche Auskunft über die zu seiner
      Person gespeicherten personenbezogenen Daten und eine Kopie dieser Auskunft zu erhalten.
      Ferner hat der Europäische Richtlinien- und Verordnungsgeber der betroffenen Person Auskunft
    ...
    <p>
      <b>c) Recht auf Berichtigung</b><br />Jede von der Verarbeitung personenbezogener Daten
      betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
      die unverzügliche Berichtigung sie betreffender unrichtiger personenbezogener Daten zu
      verlangen. Ferner steht der betroffenen Person das Recht zu, unter Berücksichtigung der Zwecke
      der Verarbeitung, die Vervollständigung unvollständiger personenbezogener Daten — auch mittels
    ...
    <p>
      <b>d) Recht auf Löschung (Recht auf Vergessen werden)</b><br />Jede von der Verarbeitung
    ...
    <p>
      ...
      personenbezogenen Daten, die beim DJK 1. SC Klarenthal 1968 e. V. gespeichert sind,
      veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
      Verarbeitung Verantwortlichen wenden. Der Mitarbeiter des DJK 1. SC Klarenthal 1968 e. V. wird
      veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
    </p>
    <p>
      Wurden die personenbezogenen Daten vom DJK 1. SC Klarenthal 1968 e. V. öffentlich gemacht und
      ist unser Verein als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
      personenbezogenen Daten verpflichtet, so trifft der DJK 1. SC Klarenthal 1968 e. V. unter
      ...
      Der Mitarbeiter des DJK 1. SC Klarenthal 1968 e. V. wird im Einzelfall das Notwendige
      veranlassen.
    </p>
    <p>
      <b>e) Recht auf Einschränkung der Verarbeitung</b><br />Jede von der Verarbeitung
      personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien- und
      Verordnungsgeber gewährte Recht, von dem Verantwortlichen die Einschränkung der Verarbeitung
    ...
    <p>
      ...
      Einschränkung von personenbezogenen Daten, die beim DJK 1. SC Klarenthal 1968 e. V.
      gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des
      für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter des DJK 1. SC Klarenthal 1968 e.
      V. wird die Einschränkung der Verarbeitung veranlassen.
    </p>
    <p>
      <b>f) Recht auf Datenübertragbarkeit</b><br />Jede von der Verarbeitung personenbezogener
      Daten betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
      Recht, die sie betreffenden personenbezogenen Daten, welche durch die betroffene Person einem
      ...
      bereitgestellt wurden, zu übermitteln, sofern die Verarbeitung auf der Einwilligung gemäß Art.
    ...
    <p>
      ...
      jederzeit an einen Mitarbeiter des DJK 1. SC Klarenthal 1968 e. V. wenden.
    </p>
    <p>
      <b>g) Recht auf Widerspruch</b><br />Jede von der Verarbeitung personenbezogener Daten
      betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
      aus Gründen, die sich aus ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung
      sie betreffender personenbezogener Daten, die aufgrund von Art. 6 Abs. 1 Buchstaben e oder f
      DS-GVO erfolgt, Widerspruch einzulegen. Dies gilt auch für ein auf diese Bestimmungen
      gestütztes Profiling.
    </p>
    <p>
      Der DJK 1. SC Klarenthal 1968 e. V. verarbeitet die personenbezogenen Daten im Falle des
    ...
    <p>
      Verarbeitet der DJK 1. SC Klarenthal 1968 e. V. personenbezogene Daten, um Direktwerbung zu
      ...
      die betroffene Person gegenüber dem DJK 1. SC Klarenthal 1968 e. V. der Verarbeitung für
      Zwecke der Direktwerbung, so wird der DJK 1. SC Klarenthal 1968 e. V. die personenbezogenen
      Daten nicht mehr für diese Zwecke verarbeiten.
    </p>
    <p>
      Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen
      Situation ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten, die beim
      DJK 1. SC Klarenthal 1968 e. V. zu wissenschaftlichen oder historischen Forschungszwecken oder
    ...
    <p>
      ...
      Mitarbeiter des DJK 1. SC Klarenthal 1968 e. V. oder einen anderen Mitarbeiter wenden. Der
    ...
    <p>
      <b>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</b><br />Jede von
      der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen
    ...
    <p>
      ...
      ausdrücklicher Einwilligung der betroffenen Person, trifft der DJK 1. SC Klarenthal 1968 e. V.
    ...
    <p>
      <b>i) Recht auf Widerruf einer datenschutzrechtlichen Einwilligung</b><br />Jede von der
      Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
      und Verordnungsgeber gewährte Recht, eine Einwilligung zur Verarbeitung personenbezogener
    ...
    <h3>12. Datenschutz bei Bewerbungen und im Bewerbungsverfahren</h3>
    <p>
      Der für die Verarbeitung Verantwortliche erhebt und verarbeitet die personenbezogenen Daten
      von Bewerbern zum Zwecke der Abwicklung des Bewerbungsverfahrens. Die Verarbeitung kann auch
      ...
      gespeichert. Wird von dem für die Verarbeitung Verantwortlichen kein Anstellungsvertrag mit
      dem Bewerber geschlossen, so werden die Bewerbungsunterlagen zwei Monate nach Bekanntgabe der
    ...
    <h3>13. Datenschutzbestimmungen zu Einsatz und Verwendung von Facebook</h3>
    <p>
    ...
    <p>
      ...
      unabhängig davon statt, ob die betroffene Person die Facebook-Komponente anklickt oder nicht.
      Ist eine derartige Übermittlung dieser Informationen an Facebook von der betroffenen Person
    ...
    <p>
      ...
      Daten durch Facebook. Ferner wird dort erläutert, welche Einstellungsmöglichkeiten Facebook
      zum Schutz der Privatsphäre der betroffenen Person bietet. Zudem sind unterschiedliche
      Applikationen erhältlich, die es ermöglichen, eine Datenübermittlung an Facebook zu
      unterdrücken, beispielsweise der Facebook-Blocker des Anbieters Webgraph, der unter
      <a href="http://webgraph.com/resources/facebookblocker/"
        >http://webgraph.com/resources/facebookblocker/</a
      >
      bezogen werden kann. Solche Applikationen können durch die betroffene Person genutzt werden,
    ...
    <p>
      ...
      Analytics, auf eine Nutzung dieser Internetseite bezogenen Daten sowie der Verarbeitung dieser
      ...
      übermittelt werden dürfen. Die Installation des Browser-Add-Ons wird von Google als
      Widerspruch gewertet. Wird das informationstechnologische System der betroffenen Person zu
      einem späteren Zeitpunkt gelöscht, formatiert oder neu installiert, muss durch die betroffene
      Person eine erneute Installation des Browser-Add-Ons erfolgen, um Google Analytics zu
      deaktivieren. Sofern das Browser-Add-On durch die betroffene Person oder einer anderen Person,
      die ihrem Machtbereich zuzurechnen ist, deinstalliert oder deaktiviert wird, besteht die
